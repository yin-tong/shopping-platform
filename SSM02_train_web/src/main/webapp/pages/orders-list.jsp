...
<body class="hold-transition skin-purple sidebar-mini">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/orders/findAll'"><i class="fa fa-refresh"></i> 刷新</button>
                                    </div>
                                </div>
                            </div>
                            <div class="box-tools pull-right">
                                <div class="has-feedback">
                                    <input type="text" class="form-control input-sm" placeholder="根据用户名搜索" id="input" onkeydown="findOrdersByUsername()">
    ...
    <script>
        function findOrdersByUsername(){
            var event = window.event || arguments.callee.caller.arguments[0];
            if (event.keyCode == 13) {
                var inputName = document.getElementById("input");
                var name = inputName.value;
                location.href="${pageContext.request.contextPath}/orders/findOrdersByUsername?username="+name;
            }
        }
        ...
        function deleteOrders(){
            ...
            if(!falg){
                ...
                orderTableForm.action="${pageContext.request.contextPath}/orders/delete";
