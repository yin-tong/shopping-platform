                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="删除" onclick="deleteOrders()"><i class="fa fa-trash-o"></i> 删除</button>
                                        <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/orders/findByUsername?username=<security:authentication property="principal.username"/>'"><i class="fa fa-refresh"></i> 刷新</button>
                                    </div>
                                </div>
                            </div>
<%--                            <div class="box-tools pull-right">--%>
<%--                                <div class="has-feedback">--%>
<%--                                    <input type="text" class="form-control input-sm" placeholder="搜索" id="input" onclick="findOrdersLikeProductName()">--%>
...
<%--                            </div>--%>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/refund?id=${order.id}'">申请退款</button>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
                    ...
                    <div class="box-footer">
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                总共${pageInfo.pages} 页，共${ordersCnt} 条数据。 每页
    ...
    <script>
        function findOrdersLikeProductName(){
            var event = window.event || arguments.callee.caller.arguments[0];
            if (event.keyCode == 13) {
                var inputName = document.getElementById("input");
                var name = inputName.value;
                location.href="${pageContext.request.contextPath}/orders/findOrdersLikeProductName?productName="+name;
            }
        }
        ...
        function deleteOrders(){
            var orderTableForm = document.getElementById("ordersTableForm");
            orderTableForm.action="${pageContext.request.contextPath}/orders/userDelete";
            orderTableForm.submit();//表单提交
        }
    </script>
</body>
