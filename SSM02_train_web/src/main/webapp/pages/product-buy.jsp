...
<body class="hold-transition skin-purple sidebar-mini">
                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/product/buy'"><i class="fa fa-refresh"></i> 刷新</button>
                                    </div>
                                </div>
                            </div>
                                <div class="box-tools pull-right">
                                    <div class="has-feedback">
                                        <input name="name" type="text" class="form-control input-sm" placeholder="根据产品名称搜索" id="input" onkeydown="userFindProductByName()">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button id="buyButton" type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/save?productId=${product.id}&username=<security:authentication property='principal.username'/>'">购买</button>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
    ...
    <script>
        ...
        function userFindProductByName(){
            var event = window.event || arguments.callee.caller.arguments[0];
            if (event.keyCode == 13) {
                var inputName = document.getElementById("input");
                var name = inputName.value;
                location.href="${pageContext.request.contextPath}/product/userFindProductByName?name="+name;
            }
        }
