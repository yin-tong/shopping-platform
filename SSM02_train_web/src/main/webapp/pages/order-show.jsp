            ...
            <section class="content">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-2 title">下单日期</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="订单编号" value="${order.orderTimeStr}">
                        </div>

                        <div class="col-md-2 title">订单状态</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="订单状态" value="${order.orderStatusStr}">
                        </div>

                        <div class="col-md-2 title">支出方式</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="支出方式" value="${order.payTypeStr}">
                        </div>

                        <div class="col-md-2 title rowHeight2x">订单描述</div>
                        <div class="col-md-10 data rowHeight2x">
                            <textarea class="form-control" rows="3" placeholder="订单描述" vale="${order.orderDesc}"></textarea>
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control"  name="productNum" value="${order.product.productNum}">
                        </div>

                        <div class="col-md-2 title">产品名称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control pull-right" name="productName"value="${order.product.productName}">
                        </div>

                        <div class="col-md-2 title">产品价格</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="productPrice" value="￥${order.product.productPrice}">
                        </div>

                        <div class="col-md-2 title">出发城市</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control pull-right" id="datepicker-a5" name="cityName" value="${order.product.cityName}">
                        </div>

                        <div class="col-md-2 title">出发时间</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control pull-right" id="datepicker-a6" style="width: 100%;" name="departureTime" value="${order.product.departureTimeStr}">
                        </div>
                        <div class="col-md-2 title">产品状态</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control pull-right" id="datepicker-a7" style="width: 100%;" name="departureTime" value="${order.product.productStatusStr}">
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data text">
                            <input type="text" class="form-control pull-right" name="cityName" value="${order.userInfo.username}">
                        </div>

                        <div class="col-md-2 title">手机号</div>
                        <div class="col-md-4 data text">
                            <input type="text" class="form-control pull-right" name="cityName" value="${order.userInfo.phoneNum}">
                        </div>

                        <div class="col-md-2 title">邮箱</div>
                        <div class="col-md-4 data text">
                            <input type="text" class="form-control pull-right" name="cityName" value="${order.userInfo.email}">
                        </div>
